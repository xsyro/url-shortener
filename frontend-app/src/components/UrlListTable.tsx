            ...
            <table className="min-w-full border-collapse border border-gray-300">
                <thead className="bg-gray-100">
                    <tr>
                        ...
                        <th className="px-4 py-2 border border-gray-300 text-left font-medium text-gray-700">Action</th>
                    </tr>
                </thead>
                <tbody>
                    {Array.isArray(data) && data.map((url) => (
                        <tr key={url.shortUrl} className="odd:bg-white even:bg-gray-50">
                            <td className="px-4 py-2 border border-gray-300">{url.url}</td>
                            <td className="px-4 py-2 border border-gray-300">{url.shortUrl}</td>
